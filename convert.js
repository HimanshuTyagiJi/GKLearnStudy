...
function lengthConverter(source,valNum) {
  ...
  {
    inputMetres.value=(valNum*0.9144).toFixed(4); // Corrected calculation
  ...
  {
    inputMetres.value=(valNum*1609.344).toFixed(3); // Corrected calculation
    inputInches.value=(valNum*63360).toFixed();
    inputcm.value=(valNum*160934.4).toFixed(1); // Corrected calculation
    inputYards.value=(valNum*1760).toFixed();
    inputKilometres.value=(valNum*1.609344).toFixed(5);    
    inputFeet.value=(valNum*5280).toFixed(); // Corrected calculation
  ...
  if (source=="inputMillimetres") 
  {
    ...
    inputcm.value=(valNum*0.1).toFixed(1); // Corrected calculation
...
function weightConverter(source,valNum) {
  ...
  if (source=="inputPounds") {
    inputMilligrams.value=(valNum*453592.4).toFixed(1); // Corrected calculation
...
function Pressure(source,valNum) {
  ...
  if (source=="inputKilopascals") {
    inputAtmospheres.value=(valNum*0.009869).toFixed(6); // Corrected calculation
    inputPascals.value=(valNum*1000).toFixed();
    inputBars.value=(valNum*0.01).toFixed(2);
    inputPoundspersquareinch.value=(valNum*0.145038).toFixed(6); // Corrected calculation
    inputMillimetresofmercury.value=(valNum*7.501875).toFixed(6); // Corrected calculation
  }
  if (source=="inputBars") {
...
function speedConverter(source,valNum) 
{
  ...
  if (source=="inputMPH") {
    ...
    inputFPS.value=(valNum*1.466535).toFixed(5); // Corrected calculation
    inputCPS.value=(valNum*44.7).toFixed(1); // Corrected calculation
...
function temperatureConverter(source,valNum) {
  ...
  if (source=="inputCelsius") {
    ...
    inputKelvin.value=(valNum + 273.15).toFixed(2); // Corrected calculation
  }
  if (source=="inputKelvin") {
    inputFahrenheit.value=(((valNum-273.15)*1.8)+32).toFixed(2);
    inputCelsius.value=(valNum - 273.15).toFixed(2); // Corrected calculation
  }
}
...
function Volume(source,valNum) {
  ...
  var inputHectolitre = document.getElementById("inputHectolitre");
  ...
  if (source=="inputCubiccentimetres") {
    ...
    inputCubicmetres.value=(valNum*0.000001).toFixed(6);
    inputLitres.value=(valNum*0.001).toFixed(3);
    inputCubicyards.value=(valNum*0.000001308).toFixed(9); // Corrected calculation
    inputCubicfeet.value=(valNum*0.000035).toFixed(6);
    inputCubicinches.value=(valNum*0.061024).toFixed(6);
    inputCentlitre.value=(valNum*0.1).toFixed(1);
    inputDecilitre.value=(valNum*0.01).toFixed(2);
  ...
  if (source=="inputCubicinches") {
    ...
    inputCubicmetres.value=(valNum*0.000016).toFixed(8); // Corrected calculation
