...
const svgLinks = [
    {
        svg: `<svg class="svg-icon youtube-icon" viewBox="0 0 512 512">
                <g>
    ...
    {
        svg: `<svg class="svg-icon facebook-icon" viewBox="0 0 512 512">
                <g>
                    ...
                    <path d="M355.65,330l11.35,-74l-71,0l0,-48.022c0,-20.245 9.917,-39.978 41.719,-39.978l32.281,0l0,-63c0,0 -29.297,-5 -57.305,-5c-58.476,0 -96.695,35.44 -96.695,99.6l0,56.4l-65,0l0,74l65,0l0,178.89c13.033,2.045 26.392,3.11 40,3.11c13.608,0 26.966,-1.065 40,-3.11l0,-178.89l59.65,0Z" style="fill:#fff;"/>
                </g>
            </svg>`,
    ...
    {
        svg: `<svg class="svg-icon instagram-icon" viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg">
                <!-- Instagram paths and gradients can go here (cleaned & CSS defined separately) -->
            </svg>`,
